...
- The package now lives in the `UnityPackage/` folder of the repository. Git URL installs must append `?path=/UnityPackage` (e.g. `https://github.com/reromanlee/EventAggregator.git?path=/UnityPackage`); the old root URL no longer resolves.
